...
var configure = function configure(breakpoints) {
  ...
  var breakpointsArray = function breakpointsArray() {
    return compose(reverse, sort(prop('value')))(toBreakpointArray(breakpoints));
  };
  ...
  var aboveWidth = function aboveWidth(from) {
    return function (stringParts) {
      for (var _len = arguments.length, interpolationValues = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        interpolationValues[_key - 1] = arguments[_key];
      }

      return css(_templateObject, defaultMediaType, minWidth(from), css.apply(undefined, [stringParts].concat(interpolationValues)));
    };
  };
  ...
  var belowWidth = function belowWidth(to) {
    return function (stringParts) {
      ...
      return css(_templateObject, defaultMediaType, maxWidth(to), css.apply(undefined, [stringParts].concat(interpolationValues)));
    };
  };
  ...
  var betweenWidths = function betweenWidths(from, to) {
    return function (stringParts) {
      ...
      return css(_templateObject2, defaultMediaType, minWidth(from), maxWidth(to), css.apply(undefined, [stringParts].concat(interpolationValues)));
    };
  };

  var atBreakpoint = function atBreakpoint(breakpoint) {
    return function (stringParts) {
      ...
      if (nextBreakpointWider) {
        return betweenWidths(breakpoint, nextBreakpointWider).apply(undefined, [stringParts].concat(interpolationValues));
      }
      return aboveWidth(breakpoint).apply(undefined, [stringParts].concat(interpolationValues));
    };
  };
